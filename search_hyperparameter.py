...
def generate_hyperparameter():
    ...
    network_config = {'batch_size': 32, 'rnn_cell': rnn_cells[rnn_cell],
                      'hidden_layer_structure': hidden_layer_structure, 'learning_rate': learning_rate,
                      'keep_prob': keep_prob, 'embedding_size': embedding_size, 'lambda_o': lambda_o,
                      'lambda_w1': lambda_w}
